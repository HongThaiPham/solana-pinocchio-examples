...
mod tests {
    ...
    use spl_token_minter::{
        instructions::{CreateTokenInstructionData, MintTokenInstructionData},
        ID,
    };
    ...
    fn get_mollusk() -> Mollusk {
        let mut mollusk = Mollusk::new(&PROGRAM_ID, "../../target/deploy/spl_token_minter");
