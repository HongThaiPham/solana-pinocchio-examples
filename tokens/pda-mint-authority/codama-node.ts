...
export const root = rootNode(
  programNode({
    name: 'pda-mint-authority',
    publicKey: '5JTY1h4jWJ2JfoJMxNtr6J9T1PkT2aP5mVTBm72UAhzf',
    version: '1.0.0',
    instructions: [
      instructionNode({
        ...
        arguments: [
          ...
          instructionArgumentNode({
            name: 'bump',
            type: numberTypeNode('u8'),
            docs: ['The bump seed for the mint authority PDA.'],
          }),
        ],
        accounts: [
          instructionAccountNode({
          ...
          instructionAccountNode({
            ...
            isSigner: false,
            isWritable: true,
            docs: ['The PDA mint authority account that will be created'],
          }),
          instructionAccountNode({
            name: 'systemProgram',
