...
import { TRANSFER_TOKENS_PROGRAM_ADDRESS } from '../programs';
...
export type CreateTokenInstruction<
  TProgram extends string = typeof TRANSFER_TOKENS_PROGRAM_ADDRESS,
...
export function getCreateTokenInstruction<
  ...
  TAccountTokenProgram extends string,
  TAccountSystemProgram extends string,
  TProgramAddress extends Address = typeof TRANSFER_TOKENS_PROGRAM_ADDRESS,
>(
...
> {
  ...
  const programAddress =
    config?.programAddress ?? TRANSFER_TOKENS_PROGRAM_ADDRESS;
